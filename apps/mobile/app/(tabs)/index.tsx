...
export default function HomeScreen() {
    ...
    <View style={{ backgroundColor: 'transparent' }}>
      ...
      <Animated.View entering={FadeIn.delay(200)} style={styles.flashDealHeader}>
        <Text 
          variant="overline" 
          family="heading" 
          style={{ color: colors.chili, letterSpacing: 2 }}
  ...
  const FooterComponent = () => (
    <View style={{ backgroundColor: 'transparent' }}>
      ...
      {/* Combo Packs */}
      <Animated.View entering={FadeInUp.delay(800)} style={styles.sectionHeader}>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  flashListContent: { paddingTop: 10, paddingHorizontal: 5 },
  flashDealHeader: { 
    alignItems: 'center', 
    marginVertical: 10,
