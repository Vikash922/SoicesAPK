    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <Animated.View entering={FadeIn.duration(800)} style={styles.content}>
        ...
        <Text variant="body2" style={styles.description}>
          Your order #SPC-2847 has been placed and is being prepared for shipment.
        </Text>

        <View style={[styles.orderCard, { backgroundColor: colors.card || '#fff' }]}>
           <View style={styles.orderInfoRow}>
              <Text variant="caption">Delivery ETA</Text>
              <Text variant="body2" family="heading">Today, 5:30 PM</Text>
           </View>
           <View style={styles.orderInfoRow}>
              <Text variant="caption">Total Amount</Text>
              <Text variant="body2" family="heading">₹897.00</Text>
           </View>
        </View>
      </Animated.View>
      ...
      <View style={styles.footer}>
        <Button 
          title="TRACK ORDER" 
          onPress={() => router.replace('/order/1')} 
